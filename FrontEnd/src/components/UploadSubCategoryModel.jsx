            ...
            >
                ...
                >
                    <div className='flex items-center justify-between gap-3 border-b dark:border-gray-700 pb-3 mb-4'>
                        ...
                        <motion.button 
                            onClick={close}
                            className="w-8 h-8 rounded-full hover:bg-red-100 hover:text-red-500 dark:text-gray-400 dark:hover:bg-red-900/30 dark:hover:text-red-400 flex items-center justify-center transition-all duration-300"
                    ...
                    >
                        ...
                        >
                            <label htmlFor='name' className="flex items-center gap-2 font-medium text-gray-700 dark:text-gray-200">
                        ...
                        <motion.div 
                            ...
                            custom={1}
                        >
                            <p className="flex items-center gap-2 font-medium text-gray-700 dark:text-gray-200">
                            ...
                            <div className='flex flex-col lg:flex-row items-center gap-4'>
                                <motion.div 
                                    className={`
                                        ...
                                        ${isDragging ? 'border-primary-200 bg-blue-100 dark:bg-gray-600' : 'border-dashed border-gray-300 dark:border-gray-600'} 
                                        h-40 w-full lg:w-40 flex items-center justify-center transition-all duration-300 bg-white dark:bg-gray-700
                                    `}
                                ...
                                >
                                    {loading ? (
                                        <div className="animate-pulse flex flex-col items-center">
                                            ...
                                            <p className="text-sm mt-2 text-gray-500 dark:text-gray-400">Uploading...</p>
                                        </div>
                                ...
                                <div className="flex flex-col space-y-2 w-full lg:w-auto">
                                    <motion.label 
                                        ...
                                        whileTap={{ scale: 0.97 }}
                                    >
                                        <div className='px-5 py-3 bg-blue-50 dark:bg-gray-700 border-2 border-primary-100 dark:border-primary-900 text-primary-200 rounded-lg hover:bg-primary-100 hover:text-white cursor-pointer transition-all duration-300 font-medium flex items-center justify-center gap-2'>
                                            <FaCamera size={16} />
                        ...
                        >
                            ...
                            <div className='border border-gray-300 dark:border-gray-600 focus-within:border-primary-200 rounded-lg overflow-hidden'>
                                ...
                                <motion.div 
                                    className='flex flex-wrap gap-1 p-2 min-h-10 bg-white dark:bg-gray-800'
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                >
                                    <AnimatePresence>
                                ...
                                <motion.select
                                    className='w-full p-3 bg-transparent dark:bg-gray-800 dark:text-white outline-none border-t border-gray-200 dark:border-gray-700'
                                    onChange={(e) => {
                                ...
                                >
                                    ...
                                    {allCategory.map((category, index) => (
                                        <option value={category?._id} key={category._id + "subcategory"} className="dark:bg-gray-800">
                                            {category?.name}
                                        </option>
                                    ))}
                                </motion.select>
