...
const AddFieldComponent = ({close,value,onChange,submit}) => {
  return (
   <section className='fixed top-0 bottom-0 right-0 left-0 bg-neutral-900 dark:bg-black bg-opacity-70 dark:bg-opacity-80 z-50 flex justify-center items-center p-4 transition-colors duration-300'>
